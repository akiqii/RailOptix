    ...
    const html = `
      ...
      <div style="background: rgba(30, 41, 59, 0.7); border: 1px solid var(--border-color); border-radius: 8px; padding: 14px 18px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px;">
        ...
        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
          <a href="/api/download/${scen}/SCHEDULE_ACCESS.csv" download="${scen}_SCHEDULE_ACCESS.csv" class="btn btn-sm" style="background: rgba(59, 130, 246, 0.2); color: #93c5fd; border: 1px solid rgba(59, 130, 246, 0.4); text-decoration: none; padding: 4px 10px; font-size: 11px; border-radius: 4px; display: inline-flex; align-items: center; gap: 4px;">
            <span>📄</span> SCHEDULE_ACCESS.csv
          </a>
          <a href="/api/download/${scen}/SCHEDULE_OCCUPANCY.csv" download="${scen}_SCHEDULE_OCCUPANCY.csv" class="btn btn-sm" style="background: rgba(59, 130, 246, 0.2); color: #93c5fd; border: 1px solid rgba(59, 130, 246, 0.4); text-decoration: none; padding: 4px 10px; font-size: 11px; border-radius: 4px; display: inline-flex; align-items: center; gap: 4px;">
            <span>📄</span> SCHEDULE_OCCUPANCY.csv
          </a>
          <a href="/api/download/${scen}/RESULTS.csv" download="${scen}_RESULTS.csv" class="btn btn-sm" style="background: rgba(16, 185, 129, 0.2); color: #6ee7b7; border: 1px solid rgba(16, 185, 129, 0.4); text-decoration: none; padding: 4px 10px; font-size: 11px; border-radius: 4px; display: inline-flex; align-items: center; gap: 4px;">
            <span>📄</span> RESULTS.csv
          </a>
          <a href="/api/export/${scen}" download="RailOptix_Scenario_${scen}_Deliverables.zip" class="btn btn-sm" style="background: linear-gradient(135deg, #f59e0b, #d97706); color: #000; font-weight: 700; text-decoration: none; padding: 4px 12px; font-size: 11px; border-radius: 4px; display: inline-flex; align-items: center; gap: 4px;">
